...
public class ClienteResourceIntTest {
    ...
    private static final String DEFAULT_DOCUMENTO = "40";
    private static final String UPDATED_DOCUMENTO = "3";
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.getTipodocumento()).isEqualTo(DEFAULT_TIPODOCUMENTO);
    ...
    public void updateCliente() throws Exception {
        ...
        Cliente testCliente = clienteList.get(clienteList.size() - 1);
        assertThat(testCliente.getTipodocumento()).isEqualTo(UPDATED_TIPODOCUMENTO);
